...
function buildVersions() {
  return new Array(
    ...
    new Version(9, new Array(6, 26, 46),
    ...
    new Version(11, new Array(6, 30, 54),
    ...
    new Version(13, new Array(6, 34, 62),
